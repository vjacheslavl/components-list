...
```
git clone git@git.atlasaero.space:vjaceslavs/components-list.git
cd components-list
docker-compose up
```
...
### API 
Jenkins supposed to be a data source for information of this tool

POST to <host>:<port>/api/firmwares

Payload
```
{ "name": "ChibiOS-Arducopter-v3",
"version": "3.92",
"description": "Some description. Optional",
"revision": "Git revision from Jenkins. Optional",
"jenkinsLink": "http://192.168.50.190:8080/job/ChibiOS-Arducopter-v3/7/",
"isReleased": false,
"isBeta": false,
"isQaDone":false }
```
